...
Emu is a language and framework for programming GPUs.
...
It's always nice to start off with a quick example. Here's an example where you have a bunch of data, a function for multiplying, a function for taking sigmoid and you want to call the multiplication and sigmoid on the data.
